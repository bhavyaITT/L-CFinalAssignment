...
namespace PRM.Application.UseCases
{
    //public class GetSkillUseCase(IUnitOfWork unitOfWork)
    {
        ...
        //{
        //    if (!await unitOfWork.Employees.AnyAsync(e => e.Id == employeeId && e.IsActive, ct))
        ...
        //    var employee = await unitOfWork.Employees.GetByIdAsync(employeeId, ct);
            //var employeeWithSkills = await unitOfWork.Employees.Include(e => e.Skills).FirstOrDefaultAsync(e => e.Id == employeeId);
